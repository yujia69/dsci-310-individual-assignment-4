...
knitr::include_graphics("../results/horse_pop_plot.png")
```

We can see from @fig-horse-populations that Ontario, Saskatchewan and Alberta have had the highest horse populations in Canada.
...
@tbl-horses-sd Standard deviation of historical (1906-1972) horse populations for each Canadian province.
